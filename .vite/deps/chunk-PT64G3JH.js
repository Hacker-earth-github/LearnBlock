import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-Z7TQ6PIM.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-6JE3SBOK.js";
import {
  CaipNetworksUtil,
...
import {
  solana,
  solanaDevnet
} from "./chunk-BUNK4M3E.js";
import {
  toHex
} from "./chunk-2XWXXSG6.js";
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-EMSQX6GS.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-MO7CDS5E.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-CMT5YEK7.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-JVJUDJUX.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-HDXKHOQC.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-QKMFJ2DV.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-JPHAGQCU.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-SLGP3O5N.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-NDZJHQOF.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-LFNGMJXX.js"),
      import("./w3m-modal-SE6423NQ.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-PT64G3JH.js.map
